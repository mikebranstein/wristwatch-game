...
MATERIAL_UPLIFT_THRESHOLD = 10.0   # Percentage-point D30 uplift to confirm hypothesis (AC2)
QUEUE_GAP_STRONG_THRESHOLD = 40.0  # % returning sessions with no active job → strong signal (AC3)
